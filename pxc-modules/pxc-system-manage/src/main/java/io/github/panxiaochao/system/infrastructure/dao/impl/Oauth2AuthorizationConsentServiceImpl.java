...
import io.github.panxiaochao.system.infrastructure.dao.mapper.Oauth2AuthorizationConsentMapper;
...
public class Oauth2AuthorizationConsentServiceImpl
		implements IOauth2AuthorizationConsentService, IOauth2AuthorizationConsentReadModelService {
	 ...
	 */
	@Override
	public List<Oauth2AuthorizationConsentQueryResponse> page(Pagination pagination,
	 ...
	 * @return 角色表Lambda表达式
	 */
	private LambdaQueryWrapper<Oauth2AuthorizationConsentPO> lambdaQuery(
			Oauth2AuthorizationConsentQueryRequest queryRequest) {
	...
	public Oauth2AuthorizationConsent save(Oauth2AuthorizationConsent oauth2AuthorizationConsent) {
		Oauth2AuthorizationConsentPO oauth2AuthorizationConsentPO = IOauth2AuthorizationConsentPOConvert.INSTANCE
			.fromEntity(oauth2AuthorizationConsent);
