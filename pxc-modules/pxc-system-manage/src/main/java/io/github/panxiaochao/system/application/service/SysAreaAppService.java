...
public class SysAreaAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysAreaQueryResponse> page(PageRequest pageRequest, SysAreaQueryRequest queryRequest) {
	...
	public List<Select<Integer>> selectAreaLevels() {
		List<CacheHelper.SysDictItem> list = CacheHelper.getSysDictItemListByCode(AREA_LEVEL);
