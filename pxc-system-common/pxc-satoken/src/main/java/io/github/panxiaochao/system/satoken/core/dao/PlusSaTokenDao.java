...
//         if (RedissonUtil.ofRedissonClient().getKeys().countExists(key)>0) {
//             RedissonUtil.set(key, value, true);
//             CAFFEINE.invalidate(key);
//         }
//     }
//
...
//         long timeout = RedissonUtil.ofRedissonClient().getBucket(key).remainTimeToLive();
...
//             RedissonUtil.set(key, object, true);
//             CAFFEINE.invalidate(key);
//         }
//     }
//
