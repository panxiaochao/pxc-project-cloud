package io.github.panxiaochao.system.code.generator.application.api.request.gentablecolumn;
...
@Setter
@ToString
@Schema(description = "代码生成表字段更新请求对象")
public class GenTableColumnUpdateRequest {
