package io.github.panxiaochao.system.code.generator.application.api.response.gentablecolumn;
...
@Setter
@ToString
@Schema(description = "代码生成表字段查询响应对象")
public class GenTableColumnQueryResponse {
