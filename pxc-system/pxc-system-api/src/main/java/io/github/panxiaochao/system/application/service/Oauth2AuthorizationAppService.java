...
public class Oauth2AuthorizationAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<Oauth2AuthorizationQueryResponse> page(RequestPage pageRequest,
			Oauth2AuthorizationQueryRequest queryRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<Oauth2AuthorizationQueryResponse> list = oauth2AuthorizationReadModelService.page(pagination,
				queryRequest);
	...
	public R<Oauth2AuthorizationResponse> getById(String id) {
		...
		Oauth2AuthorizationResponse oauth2AuthorizationResponse = IOauth2AuthorizationDTOConvert.INSTANCE
			.toResponse(oauth2Authorization);
	...
	public R<Oauth2AuthorizationResponse> save(Oauth2AuthorizationCreateRequest oauth2AuthorizationCreateRequest) {
		Oauth2Authorization oauth2Authorization = IOauth2AuthorizationDTOConvert.INSTANCE
			.fromCreateRequest(oauth2AuthorizationCreateRequest);
	...
	public R<Void> update(Oauth2AuthorizationUpdateRequest oauth2AuthorizationUpdateRequest) {
		Oauth2Authorization oauth2Authorization = IOauth2AuthorizationDTOConvert.INSTANCE
			.fromUpdateRequest(oauth2AuthorizationUpdateRequest);
