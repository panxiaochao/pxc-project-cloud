...
public class SysMenuAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysMenuQueryResponse> page(RequestPage<SysMenuQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<SysMenuQueryResponse> list = sysMenuReadModelService.page(pagination, pageRequest);
