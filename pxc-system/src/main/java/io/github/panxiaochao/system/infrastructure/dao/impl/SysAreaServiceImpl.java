...
public class SysAreaServiceImpl implements ISysAreaService, ISysAreaReadModelService {
	 ...
	 */
	@Override
	public List<SysAreaQueryResponse> page(Pagination pagination, RequestPage<SysAreaQueryRequest> pageRequest) {
		// 构造查询条件
		LambdaQueryWrapper<SysAreaPO> lqw = lambdaQuery(pageRequest.getParamsObject());
		// 默认按照主键倒序排序
