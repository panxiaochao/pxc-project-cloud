...
public class SysOrgAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysOrgQueryResponse> page(RequestPage<SysOrgQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<SysOrgQueryResponse> list = sysOrgReadModelService.page(pagination, pageRequest);
