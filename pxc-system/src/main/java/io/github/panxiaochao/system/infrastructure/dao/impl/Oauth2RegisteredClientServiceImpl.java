...
public class Oauth2RegisteredClientServiceImpl
		implements IOauth2RegisteredClientService, IOauth2RegisteredClientReadModelService {
	 ...
	 */
	@Override
	public List<Oauth2RegisteredClientQueryResponse> page(Pagination pagination,
	...
	public Oauth2RegisteredClient save(Oauth2RegisteredClient oauth2RegisteredClient) {
		Oauth2RegisteredClientPO oauth2RegisteredClientPO = IOauth2RegisteredClientPOConvert.INSTANCE
			.fromEntity(oauth2RegisteredClient);
