...
public class SysUserRoleAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysUserRoleQueryResponse> page(RequestPage<SysUserRoleQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<SysUserRoleQueryResponse> list = sysUserRoleReadModelService.page(pagination, pageRequest);
