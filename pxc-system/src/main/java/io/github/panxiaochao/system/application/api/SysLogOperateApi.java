...
public class SysLogOperateApi {
    ...
    public R<PageResponse<SysLogOperateQueryResponse>> page(@RequestBody RequestPage<SysLogOperateQueryRequest> pageRequest) {
        return R.ok(sysLogOperateAppService.page(pageRequest));
    }
