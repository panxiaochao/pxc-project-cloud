...
public class Oauth2AuthorizationConsentAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<Oauth2AuthorizationConsentQueryResponse> page(
	...
	public R<Oauth2AuthorizationConsentResponse> getById(String id) {
		...
		Oauth2AuthorizationConsentResponse oauth2AuthorizationConsentResponse = IOauth2AuthorizationConsentDTOConvert.INSTANCE
			.toResponse(oauth2AuthorizationConsent);
	...
	public R<Oauth2AuthorizationConsentResponse> save(
			Oauth2AuthorizationConsentCreateRequest oauth2AuthorizationConsentCreateRequest) {
		Oauth2AuthorizationConsent oauth2AuthorizationConsent = IOauth2AuthorizationConsentDTOConvert.INSTANCE
			.fromCreateRequest(oauth2AuthorizationConsentCreateRequest);
	...
	public R<Void> update(Oauth2AuthorizationConsentUpdateRequest oauth2AuthorizationConsentUpdateRequest) {
		Oauth2AuthorizationConsent oauth2AuthorizationConsent = IOauth2AuthorizationConsentDTOConvert.INSTANCE
			.fromUpdateRequest(oauth2AuthorizationConsentUpdateRequest);
