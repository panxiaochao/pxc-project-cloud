...
public class Oauth2AuthorizationAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<Oauth2AuthorizationQueryResponse> page(
			RequestPage<Oauth2AuthorizationQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<Oauth2AuthorizationQueryResponse> list = oauth2AuthorizationReadModelService.page(pagination, pageRequest);
