...
public class SysUserAuthsAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysUserAuthsQueryResponse> page(RequestPage<SysUserAuthsQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<SysUserAuthsQueryResponse> list = sysUserAuthsReadModelService.page(pagination, pageRequest);
