...
public class Oauth2RegisteredClientApi {
	...
	public R<PageResponse<Oauth2RegisteredClientQueryResponse>> page(
			@RequestBody RequestPage<Oauth2RegisteredClientQueryRequest> pageRequest) {
		return R.ok(oauth2RegisteredClientAppService.page(pageRequest));
	}
	...
	public R<Oauth2RegisteredClientResponse> save(
			@RequestBody Oauth2RegisteredClientCreateRequest oauth2RegisteredClientCreateRequest) {
