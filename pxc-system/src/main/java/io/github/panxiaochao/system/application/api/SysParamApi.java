...
public class SysParamApi {
    ...
    public R<PageResponse<SysParamQueryResponse>> page(@RequestBody RequestPage<SysParamQueryRequest> pageRequest) {
        return R.ok(sysParamAppService.page(pageRequest));
    }
