...
public class Oauth2RegisteredClientAppService {
     ...
     * @return 分页数组响应实体
     */
    public PageResponse<Oauth2RegisteredClientQueryResponse> page(RequestPage pageRequest, Oauth2RegisteredClientQueryRequest queryRequest) {
        Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
        List<Oauth2RegisteredClientQueryResponse> list = oauth2RegisteredClientReadModelService.page(pagination, queryRequest);
    ...
    public R<Oauth2RegisteredClientResponse> getById(String id) {
        ...
        Oauth2RegisteredClientResponse oauth2RegisteredClientResponse = IOauth2RegisteredClientDTOConvert.INSTANCE.toResponse(oauth2RegisteredClient);
     ...
     * @return 返回保存对象
     */
    public R<Oauth2RegisteredClientResponse> save(Oauth2RegisteredClientCreateRequest oauth2RegisteredClientCreateRequest) {
        Oauth2RegisteredClient oauth2RegisteredClient = IOauth2RegisteredClientDTOConvert.INSTANCE.fromCreateRequest(oauth2RegisteredClientCreateRequest);
    ...
    public R<Void> update(Oauth2RegisteredClientUpdateRequest oauth2RegisteredClientUpdateRequest) {
        Oauth2RegisteredClient oauth2RegisteredClient = IOauth2RegisteredClientDTOConvert.INSTANCE.fromUpdateRequest(oauth2RegisteredClientUpdateRequest);
