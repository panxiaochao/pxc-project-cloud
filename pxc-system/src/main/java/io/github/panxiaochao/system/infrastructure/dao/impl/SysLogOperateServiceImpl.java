...
public class SysLogOperateServiceImpl implements ISysLogOperateService, ISysLogOperateReadModelService {
     ...
     */
    @Override
    public List<SysLogOperateQueryResponse> page(Pagination pagination, SysLogOperateQueryRequest queryRequest) {
        // 构造查询条件
        LambdaQueryWrapper<SysLogOperatePO> lqw = lambdaQuery(queryRequest);
        // 分页查询
