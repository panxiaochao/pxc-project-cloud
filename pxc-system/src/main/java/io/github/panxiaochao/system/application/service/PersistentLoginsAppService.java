...
public class PersistentLoginsAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<PersistentLoginsQueryResponse> page(RequestPage<PersistentLoginsQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<PersistentLoginsQueryResponse> list = persistentLoginsReadModelService.page(pagination, pageRequest);
