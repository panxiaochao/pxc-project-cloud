...
public class SysDictAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysDictQueryResponse> page(RequestPage<SysDictQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<SysDictQueryResponse> list = sysDictReadModelService.page(pagination, pageRequest);
