...
public class SysLogOperateAppService {
	 ...
	 * @return 分页数组响应实体
	 */
	public PageResponse<SysLogOperateQueryResponse> page(RequestPage<SysLogOperateQueryRequest> pageRequest) {
		Pagination pagination = new Pagination(pageRequest.getPageNo(), pageRequest.getPageSize());
		List<SysLogOperateQueryResponse> list = sysLogOperateReadModelService.page(pagination, pageRequest);
